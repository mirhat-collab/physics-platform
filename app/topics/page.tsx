                ...
                >
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                      <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#fff' }}>{topic.name}</h2>
                    ...
                    <p style={{ margin: 0, color: '#888', fontSize: 13 }}>{topic.theory?.slice(0, 120)}...</p>
                  </div>
                  <div style={{ color: isHovered ? '#fff' : '#444', fontSize: 22, flexShrink: 0, transition: 'color 0.2s' }}>→</div>
                </div>
              </Link>
            )
          })}
